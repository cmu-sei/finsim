...
activate_this = '/var/www/finsim-trans/src/finsim_trans/venv/bin/activate_this.py'
with open(activate_this) as file_:
    exec(file_.read(), dict(__file__=activate_this))

#Make sure the path matches here. Went a level up so that it refers to the folder containing the Flask code
sys.path.insert(0, '/var/www/finsim-trans/src')
from finsim_trans import app as application
