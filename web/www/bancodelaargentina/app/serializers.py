...
class UserTransactionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = (
        'AccountNumber', 'FirstName', 'LastName', 'MiddleIntial', 'Address', 'City', 'State', 'ZipCode', 'Invoice',
        'Confirmations', 'AuthType', 'PrimaryAmount')


class CommercialTransactionSerializer(serializers.ModelSerializer):
    class Meta:
        model = CommercialTransaction
        fields = (
        'FirstName', 'LastName', 'MiddleIntial', 'CardNumber', 'ExpDate', 'CVV2', 'Address', 'City', 'State', 'ZipCode',
        'Invoice', 'Confirmations', 'ResponseCode', 'AVS', 'AuthType', 'PrimaryAmount')
